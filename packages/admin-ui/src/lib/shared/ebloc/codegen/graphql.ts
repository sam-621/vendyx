...
export type GetProductsQuery = { products: { count: number, items: Array<{ id: string, createdAt: any, name: string, slug: string, onlineOnly: boolean, enabled: boolean, variants: { items: Array<{ id: string, sku: string, stock: number, price: number }> }, assets: { items: Array<{ id: string, source: string }> } }> } };
