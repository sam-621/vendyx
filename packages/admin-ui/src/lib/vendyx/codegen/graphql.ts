...
export type CommonOrderFragment = { __typename?: 'Order', id: string, code: string, createdAt: any, subtotal: number, total: number, totalQuantity: number, lines: { __typename?: 'OrderLineList', items: Array<{ __typename?: 'OrderLine', id: string, linePrice: number, quantity: number, unitPrice: number, productVariant: { __typename?: 'Variant', id: string, sku: string, product: { __typename?: 'Product', name: string, slug: string, assets: { __typename?: 'AssetList', items: Array<{ __typename?: 'Asset', id: string, source: string }> } } } }> }, customer?: { __typename?: 'Customer', id: string, firstName?: string | null, lastName: string, email: string, phoneNumber?: string | null, phoneCountryCode?: string | null } | null, address?: { __typename?: 'Address', id: string, streetLine1: string, streetLine2?: string | null, suburb: string, postalCode: string, city: string, province: string, country: string, phoneCountryCode?: string | null, phoneNumber?: string | null } | null } & { ' $fragmentName'?: 'CommonOrderFragment' };
