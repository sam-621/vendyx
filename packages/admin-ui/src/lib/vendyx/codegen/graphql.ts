...
export type CreateOptionMutation = { __typename?: 'Mutation', createOption: { __typename?: 'Option', id: string, name: string, values?: Array<{ __typename?: 'OptionValue', id: string, value: string }> | null } };
...
export type UpdateVariantMutation = { __typename?: 'Mutation', updateVariant: { __typename?: 'UpdateVariantResult', apiErrors: Array<{ __typename?: 'VariantErrorResult', message: string, code: VariantErrorCode }>, variant?: { __typename?: 'Variant', id: string } | null } };
...
export type CommonProductFragment = { __typename?: 'Product', id: string, createdAt: any, name: string, slug: string, description?: string | null, onlineOnly: boolean, published: boolean, options?: Array<{ __typename?: 'Option', id: string, name: string }> | null, variants: { __typename?: 'VariantList', items: Array<{ __typename?: 'Variant', id: string, price: number, sku: string, stock: number, published: boolean, optionValues?: Array<{ __typename?: 'OptionValue', id: string, value: string }> | null }> }, assets: { __typename?: 'AssetList', items: Array<{ __typename?: 'Asset', id: string, name: string, source: string }> } } & { ' $fragmentName'?: 'CommonProductFragment' };
