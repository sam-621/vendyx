...
export type GetAdminUiConfigQuery = { __typename?: 'Query', adminUiConfig: { __typename?: 'AdminUiConfig', branding: { __typename?: 'AdminUiConfigBranding', name: string, description: string }, extraUiModules: Array<{ __typename?: 'AdminUiConfigExtraUiModule', id: string, label: string, slug: string, icon: string }>, priceCalculators: Array<{ __typename?: 'AdminUiConfigPriceCalculators', name: string, code: string, args: Array<{ __typename?: 'AdminUiConfigPriceCalculatorsArgs', type: string, label?: string | null, placeholder?: string | null, defaultValue?: string | null, conditions?: { __typename?: 'AdminUiConfigPriceCalculatorsArgsConditions', min: number, max: number } | null }> }> } };
