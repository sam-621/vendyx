...
export type CommonPaymentMethodFragment = { __typename?: 'PaymentMethod', id: string, createdAt: any, name: string, description?: string | null, enabled: boolean, handler: { __typename?: 'ConfigurableProperty', code: string } } & { ' $fragmentName'?: 'CommonPaymentMethodFragment' };
...
export type CommonZoneFragment = { __typename?: 'Zone', id: string, createdAt: any, name: string, countries: { __typename?: 'CountryList', items: Array<{ __typename?: 'Country', id: string, name: string }> }, shippingMethods: { __typename?: 'ShippingMethodList', items: Array<{ __typename?: 'ShippingMethod', id: string, name: string, description?: string | null, enabled: boolean, pricePreview: number, priceCalculator: { __typename?: 'ConfigurableProperty', code: string, args: Array<{ __typename?: 'ConfigurablePropertyArg', key: string, value: string }> } }> } } & { ' $fragmentName'?: 'CommonZoneFragment' };
