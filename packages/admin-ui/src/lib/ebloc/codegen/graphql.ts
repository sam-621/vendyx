...
export type CommonCollectionFragment = { __typename?: 'Collection', id: string, createdAt: any, name: string, slug: string, description?: string | null, enabled: boolean, products: { __typename?: 'ProductList', count: number, items: Array<{ __typename?: 'Product', id: string, name: string, published: boolean, assets: { __typename?: 'AssetList', items: Array<{ __typename?: 'Asset', id: string, source: string }> }, variants: { __typename?: 'VariantList', items: Array<{ __typename?: 'Variant', stock: number }> } }> } } & { ' $fragmentName'?: 'CommonCollectionFragment' };

export type GetCollectionsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetCollectionsQuery = { __typename?: 'Query', collections: { __typename?: 'CollectionList', items: Array<{ __typename?: 'Collection', id: string, createdAt: any, name: string, slug: string, enabled: boolean, products: { __typename?: 'ProductList', count: number } }> } };
...
export type CommonCustomerFragment = { __typename?: 'Customer', id: string, createdAt: any, firstName?: string | null, lastName: string, email: string, phoneNumber?: string | null, phoneCountryCode?: string | null, enabled: boolean, orders: { __typename?: 'OrderList', count: number, items: Array<{ __typename?: 'Order', id: string, code: string, placedAt?: any | null, state: OrderState, total: number, shipment?: { __typename?: 'Shipment', method: { __typename?: 'ShippingMethod', id: string, name: string } } | null }> } } & { ' $fragmentName'?: 'CommonCustomerFragment' };
