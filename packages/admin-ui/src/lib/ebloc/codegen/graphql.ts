...
export type CommonCountryFragment = { __typename?: 'Country', id: string, name: string, enabled: boolean, states: { __typename?: 'StateList', items: Array<{ __typename?: 'State', id: string, name: string }> } } & { ' $fragmentName'?: 'CommonCountryFragment' };
